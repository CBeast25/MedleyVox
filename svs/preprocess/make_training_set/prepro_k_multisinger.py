...
os.makedirs(
    f"C:\\Users\\Carson\\Documents\\data\\{args.samplerate_folder_name}\\k_multisinger",
    exist_ok=True,
)
...
def task(path):
    ...
    sf.write(
        f"C:\\Users\\Carson\\Documents\\data\\{args.samplerate_folder_name}\\k_multisinger\\{basename}.wav",
        wav,
        args.sample_rate,
        subtype="PCM_16",
    )
