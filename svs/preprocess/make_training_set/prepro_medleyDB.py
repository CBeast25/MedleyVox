...
musdb_path_list = glob.glob(
    f"C:\\Users\\Carson\\Documents\\data\\{args.samplerate_folder_name}\\musdb_a_train\\*.wav"
) + glob.glob(
    f"C:\\Users\\Carson\\Documents\\data\\{args.samplerate_folder_name}\\musdb_a_test\\*.wav"
)
musdb_list = []
...
path_list1 = glob.glob("F:\\Stuff\\medleyDB\\V1\\*")


os.makedirs(
    f"C:\\Users\\Carson\\Documents\\data\\{args.samplerate_folder_name}\\medleyDB_v1_rest",
    exist_ok=True,
)
os.makedirs(
    f"C:\\Users\\Carson\\Documents\\data\\{args.samplerate_folder_name}\\medleyDB_v1_in_musdb",
    exist_ok=True,
)
...
def task1(path):
    ...
    with open(
        f"F:\\Stuff\\MedleyDB\\Metadata\\{basename}_METADATA.yaml"
    ) as stream:
            ...
            if value2["instrument"] in VOCALS:
                ...
                for i in range(intervals.shape[0]):
                    ...
                    if parsed_yaml["title"].replace(" ", "") in musdb_list:
                        sf.write(
                            f"C:\\Users\\Carson\\Documents\\data\\{args.samplerate_folder_name}\\medleyDB_v1_in_musdb\\{filename_no_wav}_{i}.wav",
                            parsed_wav,
                            args.sample_rate,
                            subtype="PCM_16",
                        )
                        ...
                        sf.write(
                            f"C:\\Users\\Carson\\Documents\\data\\{args.samplerate_folder_name}\\medleyDB_v1_rest\\{filename_no_wav}_{i}.wav",
                            parsed_wav,
                            args.sample_rate,
                            subtype="PCM_16",
                        )
...
path_list2 = glob.glob("F:\\Stuff\\medleyDB\\V2\\*")

os.makedirs(
    f"C:\\Users\\Carson\\Documents\\data\\{args.samplerate_folder_name}\\medleyDB_v2_rest",
    exist_ok=True,
        ...
        for key2, value2 in value1["raw"].items():
            if value2["instrument"] in VOCALS:
                ...
                for i in range(intervals.shape[0]):
                    ...
                    parsed_wav = wav[intervals[i, 0] : intervals[i, 1]]
                    sf.write(
                        f"C:\\Users\\Carson\\Documents\\data\\{args.samplerate_folder_name}\\medleyDB_v2_rest\\{filename_no_wav}_{i}.wav",
                        parsed_wav,
                        args.sample_rate,
                        subtype="PCM_16",
                    )
...
if __name__ == "__main__":
    r = thread_map(task1, path_list1)
    r = thread_map(task2, path_list2)
