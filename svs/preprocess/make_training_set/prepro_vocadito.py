...
path_list = glob.glob("F:\\Stuff\\vocadito\\Audio\\*.wav")

os.makedirs(
    f"C:\\Users\\Carson\\Documents\\data\\{args.samplerate_folder_name}\\vocadito",
    exist_ok=True,
)
...
def task(path):
    ...
    sf.write(
        f"C:\\Users\\Carson\\Documents\\data\\{args.samplerate_folder_name}\\vocadito\\{basename}",
        wav,
        args.sample_rate,
        subtype="PCM_16",
    )
