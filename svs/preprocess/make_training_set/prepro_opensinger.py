...
path_1 = glob.glob(
    "F:\\Stuff\\OpenSinger\\ManRaw\\*\\*.wav"
)
path_2 = glob.glob(
    "F:\\Stuff\\OpenSinger\\WomanRaw\\*\\*.wav"
)

path_list = path_1 + path_2

os.makedirs(
    f"C:\\Users\\Carson\\Documents\\data\\{args.samplerate_folder_name}\\OpenSinger",
    exist_ok=True,
)
...
def task(path):
    ...
    sf.write(
        f"C:\\Users\\Carson\\Documents\\data\\{args.samplerate_folder_name}\\OpenSinger\\{path_split[-3]}_{basename}",
        wav,
        args.sample_rate,
        subtype="PCM_16",
    )
