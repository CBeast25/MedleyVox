...
path_list = glob.glob(
    "F:\\Stuff\\VocalSet\\FULL\\*\\*\\*\\*.wav"
)

os.makedirs(
    f"C:\\Users\\Carson\\Documents\\data\\{args.samplerate_folder_name}\\VocalSet",
    exist_ok=True,
)
...
def task(path):
    ...
    sf.write(
        f"C:\\Users\\Carson\\Documents\\data\\{args.samplerate_folder_name}\\VocalSet\\{basename}",
        wav,
        args.sample_rate,
        subtype="PCM_16",
    )
