...
path_list = glob.glob("F:\\Stuff\\NUS\\*\\sing\\*.wav")

os.makedirs(
    f"C:\\Users\\Carson\\Documents\\data\\{args.samplerate_folder_name}\\NUS",
    exist_ok=True,
)
...
def task(path):
    ...
    sf.write(
        f"C:\\Users\\Carson\\Documents\\data\\{args.samplerate_folder_name}\\NUS\\{singer_name}_{basename}",
        wav,
        args.sample_rate,
        subtype="PCM_16",
    )
