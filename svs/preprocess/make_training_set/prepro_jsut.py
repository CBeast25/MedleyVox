...
path_list = glob.glob(
    "F:\\Stuff\\jsut-song_ver1\\child_song\\wav\\*.wav"
)

os.makedirs(
    f"C:\\Users\\Carson\\Documents\\data\\{args.samplerate_folder_name}\\jsut-song_ver1",
    exist_ok=True,
)
...
def task(path):
    ...
    sf.write(
        f"C:\\Users\\Carson\\Documents\\data\\{args.samplerate_folder_name}\\jsut-song_ver1\\{basename}",
        wav,
        args.sample_rate,
        subtype="PCM_16",
    )
