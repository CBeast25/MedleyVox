...
path_list = glob.glob("F:/Stuff/CSD/*/wav/*.wav")

os.makedirs(
    f"C:/Users/Carson/Documents/data/{args.samplerate_folder_name}/CSD",
    exist_ok=True,
)
...
def task(path):
    ...
    sf.write(
        f"C:/Users/Carson/Documents/data/{args.samplerate_folder_name}/CSD/{basename}",
        wav,
        args.sample_rate,
        subtype="PCM_16",
    )
