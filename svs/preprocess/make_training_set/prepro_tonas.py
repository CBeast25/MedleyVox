...
path_list = glob.glob("F:\\Stuff\\TONAS\\*\\*.wav")

os.makedirs(
    f"C:\\Users\\Carson\\Documents\\data\\{args.samplerate_folder_name}\\TONAS",
    exist_ok=True,
)
...
def task(path):
    ...
    sf.write(
        f"C:\\Users\\Carson\\Documents\\data\\{args.samplerate_folder_name}\\TONAS\\{basename}",
        wav,
        args.sample_rate,
        subtype="PCM_16",
    )
