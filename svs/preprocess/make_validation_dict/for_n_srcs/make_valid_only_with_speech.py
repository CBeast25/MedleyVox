...
# For making 'different speech + speech + speech + speech + ...' validation set.
...
data1_data2_dict = {}
for data_path in tqdm.tqdm(speech_data_list):
...
with open(".\\valid_regions_dict_speech_speech_n_srcs.json", "w") as json_file:
